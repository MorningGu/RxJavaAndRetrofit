...
import com.example.gulei.rxjavaandretrofit.ui.activity.MainActivity;
...
public class AppManager {
	...
	/**
	 * 结束除开指定类名Activity和Main外的所有Activity
	 */
	public void finishAllExceptActivityAndMain(Class<?> cls) {
		try {
			Iterator itr = activityStack.iterator();
			List<Activity> activityRemoves = new ArrayList<Activity>();
		    while (itr.hasNext()) {  
